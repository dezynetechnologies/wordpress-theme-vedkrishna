...
get_header(); ?>
    <!-- Hero Area -->
    <div class="hero-area">
    	<div class="page-banner parallax" style="background-image:url(<?php bloginfo('template_directory'); ?>/images/inside5.jpg);">
        	<div class="container">
                            ...
                            <ul class="owl-carousel carousel-fw" data-columns="6" data-autoplay="" data-pagination="no" data-arrows="yes" data-single-item="no" data-items-desktop="6" data-items-desktop-small="4" data-items-tablet="3" data-items-mobile="2">
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff5.jpg" alt=""></div>
                                            <div class="grid-item-content">
                                                <h3>Elsa Wahlgren</h3>
                                ...
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff6.jpg" alt=""></div>
                                            <div class="grid-item-content">
                                                <h3>Arjun Rathore</h3>
                                ...
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff7.jpg" alt=""></div>
                                            <div class="grid-item-content">
                                                <h3>Grace Ajimobi</h3>
                                                <span class="meta-data">Volunteer</span>
                                            </div>
                                ...
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff8.jpg" alt=""></div>
                                            <div class="grid-item-content">
                                                <h3>Majda Novak</h3>
                                ...
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff9.jpg" alt=""></div>
                                            <div class="grid-item-content">
                                                <h3>Alisha Hunt</h3>
                                                <span class="meta-data">Volunteer</span>
                                            </div>
                                ...
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff10.jpg" alt=""></div>
                                            <div class="grid-item-content">
                                                <h3>Robin Schmidt</h3>
                                                <span class="meta-data">Volunteer</span>
                                            </div>
                                ...
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff11.jpg" alt=""></div>
                                            <div class="grid-item-content">
                                                <h3>Emma Paquette</h3>
                                                <span class="meta-data">Volunteer</span>
                                            </div>
                                ...
                                <li class="item">
                                    <div class="grid-item grid-staff-item grid-staff-item-compact">
                                        <div class="grid-item-inner">
                                            <div class="media-box"><img src="<?php bloginfo('template_directory'); ?>/images/staff4.jpg" alt=""></div>
                                            <div class="grid-item-content">
