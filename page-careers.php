    	...
    	<div class="content">
        	<div class="container">
                <div class="text-align-center">
                    ...
                    <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis<br>egestas rhoncus Donec facilisis fermentum sem, ac viverra ante luctus vel.<br>Donec vel mauris quam Lorem ipsum dolor sit amet.</p>
                    ...
                    <a href="#openings" class="btn btn-primary btn-lg scrollto">Current Openings</a>
                </div>
            </div>
            <div class="spacer-75"></div>
            <div class="padding-tb75 parallax parallax-light parallax1 counters" style="background-image:url(<?php bloginfo('template_directory'); ?>/images/inside6.jpg)">
